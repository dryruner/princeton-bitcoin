...
public class Transaction {
  ...
  /** hash of the transaction, its unique id. The hash for this transaction
   *  is computed after all inputs and outputs are finalized.
   * */
  private byte[] hash;
  ...
  /** Serialize the the Transaction - all inputs and all outputs. */
